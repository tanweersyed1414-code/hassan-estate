        ...
        <div style={{ transform: "translateZ(20px)", transformStyle: "preserve-3d" }} className="absolute inset-4 rounded-xl bg-card-foreground/5 shadow-inner">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-6">
            ...
            <div className="text-card-foreground">
              <h2 className="line-clamp-2 max-w-[62%] text-2xl font-bold leading-tight tracking-tight">{title}</h2>
          ...
          <motion.img
            ...
            className="absolute -right-10 -bottom-10 h-44 w-44 rounded-2xl object-cover opacity-90 shadow-lg"
          />
        </div>
      </motion.div>
    );
